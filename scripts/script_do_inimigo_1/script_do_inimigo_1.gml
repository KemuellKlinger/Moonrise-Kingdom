...
function scr_inimigo_colisao_mulher(){
...
function scr_inimigo_checar_personagem_mulher(){
	if distance_to_object(obj_personagem) <= dist_agressivo{
		estado = src_inimigo_perseguindo_mulher;
	}
...
function scr_inimigo_escolher_estado_mulher(){
	scr_inimigo_checar_personagem_mulher();
	prox_estado = choose(scr_inimigo_andando_mulher, scr_inimigo_parado_mulher);
	
	if prox_estado == scr_inimigo_andando_mulher{
		
		estado = scr_inimigo_andando_mulher;
		
		dest_x = irandom_range(0, room_width);
		dest_y = irandom_range(0, room_height);

	}	else if prox_estado == scr_inimigo_parado_mulher{
				estado = scr_inimigo_parado_mulher;
	}
}

function scr_inimigo_andando_mulher(){
		scr_inimigo_checar_personagem_mulher();
		sprite_index = boss_correndo;
		image_speed = 1;
...
function scr_inimigo_parado_mulher(){
	scr_inimigo_checar_personagem_mulher();
	sprite_index = boss_parado;
	image_speed = 0.5;
}

function src_inimigo_perseguindo_mulher(){
...
function scr_inimigo_hit_mulher(){
